 ...
 * generated in the org.openflamingo.model.workflow package. 
...
public class ObjectFactory {
    ...
    private final static QName _Start_QNAME = new QName("http://www.openflamingo.org/schema/workflow", "start");
    private final static QName _End_QNAME = new QName("http://www.openflamingo.org/schema/workflow", "end");
    private final static QName _Action_QNAME = new QName("http://www.openflamingo.org/schema/workflow", "action");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openflamingo.model.workflow
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openflamingo.org/schema/workflow", name = "start")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openflamingo.org/schema/workflow", name = "end")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openflamingo.org/schema/workflow", name = "action")
