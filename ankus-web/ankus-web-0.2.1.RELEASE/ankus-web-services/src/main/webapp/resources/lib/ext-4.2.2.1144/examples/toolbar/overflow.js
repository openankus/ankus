            ...
            items: [
                {
                    ...
                    menu: [
                        {text: 'Menu Item 1', handler: Ext.Function.pass(handleAction, 'Menu Item 1')}
                    ]
                },
                '-',
                {
                    ...
                    menu: [
                        {text: 'Cut menu', handler: Ext.Function.pass(handleAction, 'Cut menu')}
                    ]
                },
                {
                    text: 'Copy',
                ...
                },
                {
                    ...
                    iconCls: 'add16',
                    menu: [
                        {text: 'Paste menu', handler: Ext.Function.pass(handleAction, 'Paste menu')}
                    ]
                },
                '-',
                {
