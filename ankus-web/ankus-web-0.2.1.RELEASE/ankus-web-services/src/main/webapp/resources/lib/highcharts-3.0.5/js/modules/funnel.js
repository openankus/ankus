 ...
 */
(function (d) {
    var u = d.getOptions().plotOptions, p = d.seriesTypes, D = d.merge, B = function () {
    }, z = d.each;
    ...
    p.funnel = d.extendClass(p.pie, {type: "funnel", animate: B, translate: function () {
        var a = function (k, a) {
                return/%$/.test(k) ? a * parseInt(k, 10) / 100 : parseInt(k, 10)
            }, g = 0, e = this.chart, f = e.plotWidth,
            e = e.plotHeight, h = 0, c = this.options, C = c.center, b = a(C[0], f), d = a(C[0], e), p = a(c.width, f), i, q, j = a(c.height, e), r = a(c.neckWidth, f), s = a(c.neckHeight, e), v = j - s, a = this.data, w, x, u = c.dataLabels.position === "left" ? 1 : 0, y, m, A, n, l, t, o;
        ...
        z(a, function (a) {
            ...
            n = b - i / 2;
            t = n + i;
            m > v ? (y = n = b - r / 2, A = t = b + r / 2) : l > v && (o = l, i = q(v), n = b - i / 2, t = n + i, l = v);
            w = ["M", y, m, "L", A, m, t, l];
            o && w.push(t, o, n, o);
            w.push(n, l, "Z");
            a.shapeType = "path";
