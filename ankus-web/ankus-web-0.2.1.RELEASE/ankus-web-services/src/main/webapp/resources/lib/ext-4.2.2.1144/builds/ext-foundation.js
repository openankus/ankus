...
(function () {
    var b = "4.2.2.1144", e = [""], h = /([^\d\.])/, c = /[^\d]/g, a = /[\-+]/g, g = /\s/g, d = /_/g, f;
    Ext.Version = f = Ext.extend(Object, {isVersion: true, padModes: {"~": NaN, "^": Infinity}, release: "", constructor: function (r, n) {
        ...
        var u = this, n = u.pad, r = u.parts, v = r.length, m = t.isVersion ? t : new f(t), k = m.pad, q = m.parts, p = q.length, j = Math.max(v, p), o, l, s;
        for (o = 0; o < j; o++) {
            l = (o < v) ? r[o] : n;
            s = (o < p) ? q[o] : k;
            if (l < s) {
    ...
    Ext.apply(f, {releaseValueMap: {dev: -6, alpha: -5, a: -5, beta: -4, b: -4, rc: -3, "#": -2, p: -1, pl: -1}, getComponentValue: function (i) {
        return !i ? 0 : (isNaN(i) ? this.releaseValueMap[i] || i : parseInt(i, 10))
    }, compare: function (k, j) {
        var i = k.isVersion ? k : new f(k);
        return i.compareTo(j)
    }});
    Ext.apply(Ext, {versions: {}, lastRegisteredVersion: null, setVersion: function (j, i) {
        Ext.lastRegisteredVersion = Ext.versions[j] = new f(i);
        return this
        ...
        if (f.compare(Ext.getVersion(i), k) < 1) {
            l.call(j)
        }
    }});
...
(function (c, e, g, d, f) {
    ...
    }, createOverride: function (l, k, i) {
        var m = this, n = k.override, p = k.requires, j = k.uses, o = k.compatibility, h = function () {
            var q, r;
            if (p) {
                r = p;
                p = null;
                Ext.Loader.require(r, h)
            } else {
                q = m.get(n);
                delete k.override;
                delete k.compatibility;
                delete k.requires;
                delete k.uses;
                Ext.override(q, k);
                m.triggerCreated(l);
                if (j) {
                    Ext.Loader.addUsedClasses(j)
                }
                if (i) {
                    i.call(q)
                }
