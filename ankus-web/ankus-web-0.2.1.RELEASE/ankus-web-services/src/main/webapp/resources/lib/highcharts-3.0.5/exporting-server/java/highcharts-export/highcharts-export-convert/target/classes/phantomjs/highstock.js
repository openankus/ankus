...
(function () {
    ...
    function G(a, b, c) {
        var d, e;
        if (ma(b)) v(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (v(b) &&
    ...
    function L(a, b) {
        if (Xa && b && b.opacity !== w) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        y(a.style, b)
    }
    ...
    function La(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = M.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = xa(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = ya(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function fb(a, b, c, d) {
        ...
        if (v(b)) {
            ...
            if (j >= I[Ya]) i[Nb](j >= I[za] ? 0 : k * W(i[Ab]() / k));
            if (j >= I[za]) i[Ob](j >= I[ga] ? 0 : k * W(i[Bb]() / k));
            if (j >= I[ga]) i[Cb](j >= I[Na] ? 1 : k * W(i[Oa]() / k));
            ...
            b = 1;
            h = i[mb]();
            for (var d = i.getTime(), m = i[lb](), l = i[Oa](), o = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === I[ta] ? d = nb(h + b * k, 0) : j === I[Na] ? d = nb(h, m + b * k) : !g && (j === I[ga] || j === I[Ma]) ? d = nb(h, m, l + b * k * (j === I[ga] ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(Eb(e, function (a) {
    ...
    var w, H = document, Y = window, P = Math, r = P.round, W = P.floor, pa = P.ceil, t = P.max, A = P.min, U = P.abs, ha = P.cos, ka = P.sin, bb = P.PI, qb = bb * 2 / 360, Ta = navigator.userAgent, Vb = Y.opera, Xa = /msie/i.test(Ta) && !Vb, rb = H.documentMode === 8, sb = /AppleWebKit/.test(Ta), tb = /Firefox/.test(Ta), ub = /(Mobile|Android|Windows Phone)/.test(Ta), Ea = "http://www.w3.org/2000/svg", ca = !!H.createElementNS && !!H.createElementNS(Ea, "svg").createSVGRect, cc = tb && parseInt(Ta.split("Firefox/")[1], 10) < 4, ia = !ca && !Xa && !!H.createElement("canvas").getContext, cb, gb = H.documentElement.ontouchstart !== w, Wb = {}, Kb = 0, ob, M, ya, Ra, Lb, I, qa = function () {
    ...
    M = {
        ...
        lang: { loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","), weekdays: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","), decimalPoint: ".", numericSymbols: "k,M,G,T,P,E".split(","), resetZoom: "Reset zoom", resetZoomTitle: "Reset zoom level 1:1", thousandsSep: "," }, global: {
            ...
            line: {
                allowPointSelect: !1, showCheckbox: !1, animation: { duration: 1E3 }, events: {}, lineWidth: 2, marker: { enabled: !0, lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: { hover: { enabled: !0 }, select: { fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2 } } }, point: { events: {} }, dataLabels: z(D, { enabled: !1, formatter: function () {
                    return xa(this.y, -1)
            ...
            enabled: !0, align: "center", layout: "horizontal", labelFormatter: function () {
                return this.name
            }, borderWidth: 1, borderColor: "#909090", borderRadius: 5, navigation: { activeColor: "#274b6d", inactiveColor: "#CCC" }, shadow: !1, itemStyle: { cursor: "pointer", color: "#274b6d", fontSize: "12px" }, itemHoverStyle: { color: "#000" }, itemHiddenStyle: { color: "#CCC" }, itemCheckboxStyle: {
                position: "absolute",
    ...
    Ca.prototype =
    {
        ...
        if (ma(a)) c = a, h === "circle" ? c = { x: "cx", y: "cy" }[c] || c : c === "strokeWidth" && (c = "stroke-width"), q = G(g, c) ||
            this[c] || 0, c !== "d" && c !== "visibility" && (q = parseFloat(q)); else {
            for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                e !== w && (d = e);
                if (c === "d") d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"); else if (c === "x" && h === "text") for (e = 0; e < g.childNodes.length; e++) f = g.childNodes[e], G(f, "x") === G(g, "x") && G(f, "x", d); else if (this.rotation && (c === "x" || c === "y")) o = !0; else if (c === "fill") d = i.color(d, g, c); else if (h === "circle" && (c === "x" || c === "y")) c = { x: "cx", y: "cy" }[c] || c; else if (h === "rect" && c === "r") G(g,
                    ...
                    if (d) {
                        ...
                        for (e = d.length; e--;) d[e] = C(d[e]) * a["stroke-width"];
                        d = d.join(",")
                    }
                } else if (c === "width") d = C(d); else if (c === "align") c = "text-anchor", d = { left: "start", center: "middle", right: "end" }[d]; else if (c === "title") e = g.getElementsByTagName("title")[0], e || (e = H.createElementNS(Ea, "title"), g.appendChild(e)), e.textContent = d;
                c === "strokeWidth" && (c = "stroke-width");
                if (c === "stroke-width" || c === "stroke") {
                    this[c] = d;
                    if (this.stroke && this["stroke-width"]) G(g, "stroke", this.stroke), G(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (c === "stroke-width" && d === 0 && this.hasStroke) g.removeAttribute("stroke"), this.hasStroke = !1;
                    j = !0
                }
                this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (l || (this.symbolAttr(a), l = !0), j = !0);
                if (m && /^(width|height|visibility|x|y|d|transform)$/.test(c)) for (e = m.length; e--;) G(m[e], c, c === "height" ? t(d - (m[e].cutHeight || 0), 0) : d);
        ...
        ia && c && delete a.width;
        if (Xa && !ca) c && delete a.width, L(this.element, a); else {
            for (d in a) e +=
        ...
        if (gb && a === "click") this.element.ontouchstart = function (a) {
            a.preventDefault();
            b()
        };
        this.element["on" + a] = b;
        ...
        if (!a) {
            ...
            if (b.isSVG) {
                b = a.width;
                c = a.height;
                if (Xa && e && e.fontSize === "11px" && c.toPrecision(3) === "22.7") a.height = c = 14;
                if (d) a.width = U(c * ka(f)) + U(b * ha(f)), a.height = U(c * ha(f)) + U(b * ka(f))
            }
            this.bBox = a
        }
        return a
        ...
        add: function (a) {
            ...
            if (c.handleZ) for (c = 0; c < e.length; c++) if (a = e[c], b = G(a, "zIndex"), a !== f && (C(b) > g || !v(g) && v(b))) {
                d.insertBefore(f, a);
                h = !0;
                break
            }
        ...
        if (a) {
            ...
            for (e = 1; e <= i; e++) {
                ...
                if (c) G(f, "height", t(G(f, "height") - h, 0)), f.cutHeight = h;
    ...
    Ga.prototype = {
        Element: Ca, init: function (a, b, c, d) {
            ...
            this.setSize(b, c, !1);
            var g;
            if (tb && a.getBoundingClientRect) this.subPixelFix =
                b = function () {
                    L(a, { left: 0, top: 0 });
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = G(b, "x"), j = a.styles, k = j && j.width && C(j.width), m = j && j.lineHeight, l = f.length; l--;) b.removeChild(f[l]);
            ...
            n(e, function (e, f) {
                ...
                n(l, function (e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        b.appendChild(n);
                        u++;
                        if (k) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), E, B = []; e.length || B.length;) delete a.bBox, E = a.getBBox().width, o = E > k, !o || e.length === 1 ? (e = B, B = [], e.length && (n = H.createElementNS(Ea, "tspan"), G(n, { dy: m || 16, x: i }), p && G(n, "style", p), b.appendChild(n), E > k && (k = E))) : (n.removeChild(n.firstChild), B.unshift(e.pop())), e.length &&
                            n.appendChild(H.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        }, button: function (a, b, c, d, e, f, g) {
            var h = this.label(a, b, c, null, null, null, null, null, "button"), i = 0, j, k, m, l, o, a = { x1: 0, y1: 0, x2: 0, y2: 1 }, e = z({ "stroke-width": 1, stroke: "#CCCCCC", fill: { linearGradient: a, stops: [
                [0, "#FEFEFE"],
                [1, "#F6F6F6"]
        ...
        symbol: function (a, b, c, d, e, f) {
            ...
            if (h) g = this.path(h), y(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && y(g, f); else if (i.test(a)) k = function (a, b) {
        ...
        symbols: {
            ...
            function j() {
                ...
                if (A) {
                    if (!u) a = r(-x * N), b = h ? -db : 0, q.box = u = d ? o.symbol(d, a, b, q.width, q.height) : o.rect(a, b, q.width, q.height, 0, wb[Yb]), u.add(q);
            ...
            function k() {
                ...
                c = h ? 0 : db;
                if (v(E) && (a === "center" || a === "right")) b += { center: 0.5, right: 1 }[a] * (E - p.width);
    ...
    cb = Ga;
    var ib, Z;
    if (!ca && !ia) Highcharts.VMLElement = Z = {
        init: function (a, b) {
            ...
            ma(a) && v(b) && (c = a, a = {}, a[c] = b);
            if (ma(a)) c = a, q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight :
                ...
                if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), l = !0; else if (c === "d") {
                    ...
                    e = d.length;
                    l = [];
                    for (var n; e--;) if (Ja(d[e])) l[e] = r(d[e] * 10) - 5; else if (d[e] === "Z") l[e] = "x"; else if (l[e] = d[e], d.isArc && (d[e] === "wa" || d[e] === "at")) n = d[e] === "wa" ? 1 : -1, l[e + 5] === l[e + 7] && (l[e + 7] -= n), l[e + 6] === l[e + 8] && (l[e + 8] -= n);
                    d = l.join(" ") || "x";
                    f.path = d;
                    if (m) for (e =
                                    m.length; e--;) m[e].path = m[e].cutOff ? this.cutOffPath(d, m[e].cutOff) : d;
                    l = !0
                    ...
                    g[c] = d;
                    l = !0
                } else if (c === "zIndex") d && (g[c] = d), l = !0; else if (va(c, ["x", "y", "width", "height"]) !== -1) this[c] = d, c === "x" || c === "y" ? c = { x: "left", y: "top" }[c] : d = t(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, l = !0; else if (c === "class" && h === "DIV") f.className = d; else if (c === "stroke") d =
                    i.color(d, f, c), c = "strokecolor"; else if (c === "stroke-width" || c === "strokeWidth") f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ja(d) && (d += "px"); else if (c === "dashstyle") (f.getElementsByTagName("stroke")[0] || aa(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, l = !0; else if (c === "fill") if (h === "SPAN") g.color = d; else {
                    if (h !== "IMG") f.filled = d !== ba ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor"
                } else if (c === "opacity") l = !0; else if (h === "shape" && c === "rotation") this[c] = d, f.style.left = -r(ka(d * qb) + 1) + "px",
                    f.style.top = r(ha(d * qb)) + "px"; else if (c === "translateX" || c === "translateY" || c === "rotation") this[c] = d, this.updateTransform(), l = !0; else if (c === "text") this.bBox = null, f.innerHTML = d, l = !0;
                l || (rb ? f[c] = d : G(f, c, d))
            }
            return q
        }, clip: function (a) {
        ...
        Element: Z, isIE8: Ta.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
            var d, e;
            this.alignedObjects = [];
            ...
            } else if (g.test(a) && b.tagName !== "IMG") f = wa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
    ...
    var $b;
    if (ia) Highcharts.CanVGRenderer = Z = function () {
    ...
    ab.prototype = {
        addLabel: function () {
            ...
            g = y(g, h.style);
            if (v(e)) e && e.attr({ text: b }).css(g); else {
                d = { align: h.align };
                if (Ja(h.rotation)) d.rotation = h.rotation;
            ...
            if (l && s) t === "inside" && (s = -s), d.opposite && (s = -s), b = this.getMarkPath(v, T, s, l * r, g, f), o ? o.animate({ d: b, opacity: c }) : this.mark = f.path(b).attr({ stroke: x, "stroke-width": l, opacity: c }).add(d.axisGroup);
            if (i && !isNaN(v)) i.xy =
    ...
    Fb.prototype = {
        render: function () {
            ...
            if (h) {
                ...
                if (j = t(j, b.min - d), i = A(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = { fill: u }, e.borderWidth) d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth
            } else return;
            if (v(s)) d.zIndex = s;
            if (o) q ? o.animate({ d: q }, null, o.onGetPath) : (o.hide(), o.onGetPath = function () {
                o.show()
            }); else if (q && q.length && (a.svgElem = o = N.path(q).attr(d).add(),
                x)) for (n in e = function (b) {
                o.on(b, function (c) {
                    x[b].apply(a, [c])
                })
            }, x) e(n);
            if (f && v(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                ...
                if (!g) a.label = g = N.text(f.text, 0, 0).attr({ align: f.textAlign || f.align, rotation: f.rotation, zIndex: s }).css(f.style).add();
                b = [q[1], q[4], p(q[6], q[1])];
                q = [q[2], q[5], p(q[7], q[2])];
                c = Pa(b);
                k = Pa(q);
    ...
    Da.prototype = {
        ...
        }, defaultYAxisOptions: { endOnTick: !0, gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: { align: "right", x: -8, y: 3 }, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: { rotation: 270, text: "Values" }, stackLabels: { enabled: !1, formatter: function () {
        ...
        defaultBottomAxisOptions: { labels: { align: "center", x: 0, y: 14 }, title: { rotation: 0 } }, defaultTopAxisOptions: { labels: { align: "center", x: 0, y: -5 }, title: { rotation: 0 } }, init: function (a, b) {
            ...
            if (h) g = La(h, this); else if (c) g = b; else if (d) g = ya(d, b); else if (f && a >= 1E3) for (; f-- && g === w;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = xa(b / c, -1) + e[f]);
            ...
            n(a.series, function (g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isLog && N <= 0) N = j.threshold = null;
                    if (a.isXAxis) {
                        if (j = g.xData, j.length) a.dataMin = A(p(a.dataMin, j[0]), Pa(j)), a.dataMax = t(p(a.dataMax, j[0]), ua(j))
                    } else {
                        ...
                        for (h = 0; h < fa; h++) {
                            s = j[h];
                            x = u[h];
                            if (k) r = (T = x < N) ? l : m, J = T ? n : o, v(r[s]) ? (r[s] = oa(r[s] + x), x = [x, r[s]]) : r[s] = x, c[J] || (c[J] = {}), c[J][s] || (c[J][s] = new Ub(a, a.options.stackLabels, T, s, q, k)), c[J][s].setTotal(r[s]), c[J][s].touched = f;
                            if (x !== null && x !== w && (!a.isLog || x.length || x > 0)) if (C && (x = g.modifyValue(x)), g.getExtremesFromAll ||
                                z || (j[h + 1] || s) >= y.min && (j[h - 1] || s) <= y.max) if (s = x.length) for (; s--;) x[s] !== null && (E[B++] = x[s]); else E[B++] = x
                        }
                        if (!a.usePercentage && E.length) g.dataMin = k = Pa(E), g.dataMax = g = ua(E), a.dataMin = A(p(a.dataMin, k), k), a.dataMax = t(p(a.dataMax, g), g);
                        if (v(N)) if (a.dataMin >= N) a.dataMin = N, a.ignoreMinPadding = !0; else if (a.dataMax < N) a.dataMax = N, a.ignoreMaxPadding = !0
                    }
                }
            });
            ...
            if (a >= 0.5) a = r(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08) for (var f = W(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++) j = ra(la(f) * e[h]), j > b && (!d ||
                    k <= c) && g.push(k), k > c && (m = !0), k = j
            } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = yb(a, null, P.pow(10, W(P.log(a) / P.LN10))), g = Fa(this.getLinearTickPositions(a, b, c), ra), !d) this._minorAutoInterval = a / 5;
            ...
            } else if (this.isDatetimeAxis && a.minorTickInterval === "auto") d = d.concat(fb(zb(c), this.min, this.max, a.startOfWeek)), d[0] < this.min && d.shift(); else for (b = this.min + (b[0] - this.min) % c; b <= this.max; b += c) d.push(b);
            return d
        }, adjustForMinRange: function () {
            var a = this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
            if (this.isXAxis && this.minRange === w && !this.isLog) v(a.min) || v(a.max) ? this.minRange = null : (n(this.series,
                function (a) {
                    i = a.xData;
            ...
            if (e) !a && A(b.min, p(b.dataMin, b.min)) <= 0 && Ba(10, 1), b.min = oa(ra(b.min)), b.max = oa(ra(b.max));
            ...
            if (!f && !e && (a = P.pow(10, W(P.log(b.tickInterval) / P.LN10)), !m)) b.tickInterval = yb(b.tickInterval,
                null, a, d);
            ...
            if (!i) i = f ? (b.getNonLinearTimeTicks || fb)(zb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i;
        ...
        addPlotLine: function (a) {
            ...
            if (b || a.isLinked) n(e, function (b) {
                ...
                if (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === q.align) O = t(f[a].getLabelSize(), O)
            }), a.staggerLines && (O += (a.staggerLines - 1) * 16); else for (r in f) f[r].destroy(), delete f[r];
            if (o && o.text &&
                o.enabled !== !1) {
        ...
        getLinePath: function (a) {
            ...
            if (u || f) if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function (b) {
                ...
                if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new ab(a, b)), s && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
            }), q && a.min === 0 && (j[-1] || (j[-1] = new ab(a, -1, null, !0)), j[-1].render(-1))),
                o && n(g, function (b, c) {
                    if (c % 2 === 0 && b < a.max) m[b] || (m[b] = new Fb(a)), r = b + q, t = g[c + 1] !== w ? g[c + 1] + q : a.max, m[b].options = { from: e ? la(r) : r, to: e ? la(t) : t, color: o }, m[b].render(), m[b].isActive = !0
            ...
            if (p) u = a.getLinePath(p), a.axisLine ? a.axisLine.animate({ d: u }) : a.axisLine = c.path(u).attr({ stroke: d.lineColor, "stroke-width": p, zIndex: 7 }).add(a.axisGroup), a.axisLine[x ? "show" : "hide"]();
            if (h && x) h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew = !1;
            if (l && l.enabled) {
    ...
    Gb.prototype = {
        init: function (a, b) {
            ...
            e.label.attr(f);
            if (g && (U(a -
                f.x) > 1 || U(b - f.y) > 1)) clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function () {
                e && e.move(a, b, c, d)
            }, 32)
        }, hide: function () {
            var a = this, b;
    ...
    pb.prototype = {
        init: function (a, b) {
            ...
            if (d && this.options.tooltip.shared &&
                ...
                e = [];
                h = c.length;
                for (i = 0; i < h; i++) if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b.series)) b._dist = U(k - b.clientX), j = A(j, b._dist), e.push(b);
            ...
            if (a.type === "touchstart") n(f, function (a, b) {
                ...
                if (!m) b.selectionMarker = m = y({ destroy: qa }, c.plotBox);
            ...
            a.cancelBubble = !0;
            if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, y(c, { pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i) }), K(c.series, "click", y(a, { point: c })), b.hoverPoint &&
    ...
    Hb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled) c.baseline = C(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight =
            ...
            if (!p && (a.legendGroup = d.g("legend-item").attr({ zIndex: 1 }).add(b.scrollGroup), s.drawLegendSymbol(b, a), a.legendItem = p = d.text(e.labelFormat ? La(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline,
                ...
                }), b.colorizeItem(a, a.visible), x && r)) a.checkbox = aa("input", { type: "checkbox", checked: a.selected, defaultChecked: a.selected },
            ...
            d > c && (d = c);
            if (d > 0) b !== w && $a(b, this.chart), this.nav.attr({ translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible" }), this.up.attr({ fill: d === 1 ? h : g }).css({
                cursor: d ===
                    1 ? "default" : "pointer"
    ...
    Sa.prototype = {
        init: function (a, b) {
            ...
            if (g) for (j = i; j--;) if (a =
                c[j], a.options.stacking) a.isDirty = !0;
            n(c, function (a) {
            ...
            if (!c) this.loadingDiv = c = aa(Qa, { className: "highcharts-loading" }, y(d.style, { zIndex: 10, display: ba }), this.container), this.loadingSpan = aa("span", null, d.labelStyle, c);
            ...
            e = "highcharts-" + Kb++;
            if (ma(a)) this.renderTo = a = H.getElementById(a);
            a || Ba(13, !0);
            ...
            this.resetMargins();
            e = this.axisOffset;
            if ((this.title || this.subtitle) && !v(this.optionsMarginTop)) if (m = t(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !m.floating && !m.verticalAlign &&
                m.y || 0)) this.plotTop = t(this.plotTop, m + p(k.margin, 15) + b);
            if (f.display && !l.floating) if (u === "right") {
                if (!v(i)) this.marginRight = t(this.marginRight, f.legendWidth - q + o + c)
            } else if (u === "left") {
                if (!v(h)) this.plotLeft = t(this.plotLeft, f.legendWidth + q + o + a)
            } else if (s === "top") {
                if (!v(g)) this.plotTop = t(this.plotTop, f.legendHeight + O + o + b)
            } else if (s === "bottom" && !v(j)) this.marginBottom = t(this.marginBottom, f.legendHeight - O + o + d);
            ...
            if (v(a)) d.chartWidth = e = t(0, r(a)), d.hasUserSize = !!e;
            if (v(b)) d.chartHeight = f = t(0, r(b));
            ...
            if (m) h ? h.animate(x) : this.plotBGImage = b.image(m, q, n, p, s).add();
            r ? r.animate({ width: t.width, height: t.height }) : this.clipRect = b.clipRect(t);
            if (l) g ? g.animate(g.crisp(null, q, n, p, s)) : this.plotBorder = b.rect(q, n, p, s, 0, l).attr({ stroke: a.plotBorderColor, "stroke-width": l, zIndex: 1 }).add();
            this.isDirtyBox = !1
            ...
            if (a.isReadyToRender()) a.getContainer(), K(a, "init"), a.resetMargins(),
    ...
    Ha.prototype = {
        init: function (a, b, c) {
            ...
            if (typeof a === "number" || a === null) b = { y: a }; else if (Wa(a)) {
                b = {};
                if (a.length > e) {
                    c = typeof a[0];
    ...
    $.prototype = {
        isCartesian: !0, type: "line", pointClass: Ha, sorted: !0, requireSorting: !0, pointAttrToOptions: { stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius" }, colorCounter: 0, init: function (a, b) {
            var c, d, e = a.series;
            this.chart = a;
            ...
            if (!e && !a.colorByPoint) v(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, a = d.color++), e = c[a];
            this.color = e;
            ...
            if (!this.symbol) v(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, a = c.symbol++), this.symbol = d[a];
            ...
            if (l > (d.turboThreshold ||
                ...
                if (Ja(f)) {
                    ...
                    this.xIncrement = f
                } else if (Wa(f)) if (o) for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, o + 1); else for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d[1]
            } else for (i = 0; i < l; i++) if (a[i] !== w && (d = { series: this }, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, m[i] = d.z, h && d.name)) h[i] = d.name;
            ...
            for (l = 0; l < g; l++) i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ja(e[l]))) : (b[i] ? k = b[i] : a[i] !== w && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !==
                (c = b.length) || j)) for (l = 0; l < c; l++) if (l === h && !j && (l += g), b[l]) b[l].destroyElements(), b[l].plotX = w;
            this.data = b;
            this.points = m
        }, translate: function () {
            ...
            for (a = 0; a <
                ...
                if (b && this.visible && n && n[l]) q = n[l], n = q.total, q.cum = q = q.cum - o, o = q + o, i && (q = p(m, e.min)), e.isLog && q <= 0 && (q = null), b === "percent" && (q = n ? q * 100 / n : 0, o = n ? o * 100 / n : 0), j.percentage = n ? j.y * 100 / n : 0, j.total = j.stackTotal = n, j.stackY = o;
            ...
            if (e && !da(e)) e = S[b.type].animation;
            h = "_sharedClip" + e.duration + e.easing;
            if (a) a = c[h],
                e = c[h + "m"], a || (c[h] = a = d.clipRect(y(f, { width: 0 })), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h; else {
            ...
            if (m.enabled || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === w || i.enabled, l = c.isInsidePlot(r(d), e, c.inverted), a && e !== w && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = p(i.symbol, this.symbol), j = i.indexOf("url") ===
                0, k) k.attr({ visibility: l ? ca ? "inherit" : "visible" : "hidden" }).animate(y({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {})); else {
            ...
            for (g = i.length; g--;) {
                ...
                if (h.options) for (o in m) v(c[m[o]]) && (f = !0);
                if (f) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
            ...
            if (b.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e = b, n(c, function (c) {
                ...
                if (j && !i) c.dataLabel = j.destroy(); else if (i) {
                    ...
                    if (j) if (v(f)) j.attr({ text: f }), o = !1; else {
        ...
        getGraphPath: function () {
            ...
            n(c, function (c, g) {
                var j = c[0], k = a[j];
                if (k) hb(k), k.animate({ d: f }); else if (d && f.length) {
            ...
            if (d && (f || g)) d = pa(this.yAxis.len - this.yAxis.translate(a.threshold || 0)), a = { x: 0, y: 0, width: k, height: d }, k = { x: 0, y: d, width: k, height: k - d }, b.inverted && c.isVML && (a = { x: b.plotWidth - d - b.plotLeft, y: 0, width: e, height: j }, k = {
            ...
            if (j) j.attr({ d: d }); else if (a.tracker = j = h.path(d).attr({ "class": "highcharts-tracker", "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: Xb, fill: c ? Xb : ba, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 }).addClass("highcharts-tracker").on("mouseover", o).on("mouseout",function (a) {
    ...
    D = ea($, {
        type: "area", getSegments: function () {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                b.length &&
                a.push(b)
            } else $.prototype.getSegments.call(this), a = this.segments;
            this.segments = a
        }, getSegmentPath: function (a) {
    ...
    Z = ea($, {
        ...
        getColumnMetrics: function () {
            ...
            n(a.points, function (e) {
                ...
                if (f !== w && !isNaN(f) && e.y !== null) d = e.shapeArgs, g ? (hb(g), g.animate(z(d))) : e.graphic =
            ...
            if (h && (d = z(h), g && (d = { x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width }), !j)) g ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height :
                0, d.height = 0);
            ...
            if (ca) a ? (e.scaleY = 0.001, a = A(b.pos + b.len, t(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function () {
            var a = this, b = a.chart;
            b.hasRendered && n(b.series, function (b) {
    ...
    R = {
        ...
        pointClass: ea(Ha, {
            ...
            fill: "color"
        }, getColor: qa, animate: function (a) {
            ...
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = p(e.softConnector, !0), m = e.distance, l = a.center, o = l[2] / 2, q = l[1], v = m > 0, u, s, x, w, z = [
                    [],
                    []
                ], E, B, y, A, J, C = [0, 0, 0, 0],
                db = function (a, b) {
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (A = 0; !w && b[A];) w = b[A] && b[A].dataLabel && (b[A].dataLabel.getBBox().height || 21), A++;
                for (A = 2; A--;) {
                    var b = [], G = [], I = z[A], H = I.length, D;
                    F(I, A - 0.5);
                    if (m > 0) {
                        for (J = q - o - m; J <= q + o + m; J += w) b.push(J);
                        s = b.length;
                        if (H > s) {
                            c = [].concat(I);
                            c.sort(db);
                            for (J = H; J--;) c[J].rank = J;
                            for (J = H; J--;) I[J].rank >=
                                s && I.splice(J, 1);
                            H = I.length
                        }
                        for (J = 0; J < H; J++) {
                            ...
                            c = 9999;
                            var K, L;
                            for (L = 0; L < s; L++) K = U(b[L] - x[1]), K < c && (c = K, D = L);
                            if (D < J && b[J] !== null) D = J; else for (s < H - J + D && b[J] !== null && (D = s - H + J); b[D] === null;) D++;
                            G.push({ i: D, y: b[D] });
                            b[D] = null
                        }
                        G.sort(db)
                    ...
                    for (J = 0; J < H; J++) {
                        ...
                        c = x[1];
                        if (m > 0) {
                            if (s = G.pop(), D = s.i, B = s.y, c > B && b[D + 1] !== null || c < B && b[D - 1] !== null) B = c
                        } else B = c;
                        ...
                        u.connX = E;
                        u.connY = B;
                        if (this.options.size === null) s = u.width, E - s < f ? C[3] = t(r(s - E + f), C[3]) : E + s > h - f && (C[1] = t(r(E + s - h + f), C[1])), B - w / 2 < 0 ? C[0] = t(r(-B + w / 2), C[0]) : B + w / 2 > d && (C[2] = t(r(B + w / 2 - d), C[2]))
                    }
                }
    ...
    R = ea($, R);
    Q.pie = R;
    var V = $.prototype, fc = V.processData, gc = V.generatePoints, hc = V.destroy, ic = V.tooltipHeaderFormatter, jc = {
    ...
    }, ac = { line: {}, spline: {}, area: {}, areaspline: {}, column: { approximation: "sum", groupPixelWidth: 10 }, arearange: { approximation: "range" }, areasplinerange: { approximation: "range" }, columnrange: { approximation: "range", groupPixelWidth: 10 }, candlestick: { approximation: "ohlc", groupPixelWidth: 10 }, ohlc: { approximation: "ohlc", groupPixelWidth: 5 } }, bc = [
        [kb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
        [eb, [1, 2, 5, 10, 15, 30]],
        [Ya, [1, 2, 5, 10, 15, 30]],
        [za, [1, 2, 3, 4, 6,
    ...
    V.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, m = !!b, l = [
            ...
            [],
            []
        ], d = typeof d === "function" ? d : Ia[d], o = this.pointArrayMap, q = o && o.length, n;
        for (n = 0; n <= i; n++) {
            for (; c[1] !== w && a[n] >= c[1] || n === i;) if (j = c.shift(),
                k = d.apply(0, l), k !== w && (g.push(j), h.push(k)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                j = this.cropStart + n;
    ...
    V.processData = function () {
        ...
        if (fc.apply(this, arguments) !== !1 && d) {
            ...
            if (!h.groupPixelWidth) {
                for (a = k.length; a--;) k[a].xAxis === h && k[a].options.dataGrouping && (i = t(i, k[a].options.dataGrouping.groupPixelWidth));
                h.groupPixelWidth = i
            }
            if (j > g / i || j && c.forced) {
                e = !0;
    ...
    V.tooltipHeaderFormatter = function (a) {
        ...
        if (f && f.options.type === "datetime" && c && Ja(a.key)) {
            ...
            if (g) f =
                c[g.unitName], g.count === 1 ? d = f[0] : (d = f[1], e = f[2]); else if (!d && c) for (h in I) if (I[h] >= f.closestPointRange) {
                d = c[h][0];
                break
            }
            d = ya(d, a.key);
    ...
    sa(V, "setOptions", function (a, b) {
        ...
        if (ac[d]) f || (f = z(jc, ac[d])), c.dataGrouping =
    ...
    R = ea(R, {
        type: "candlestick", pointAttrToOptions: { fill: "color", stroke: "lineColor", "stroke-width": "lineWidth" }, upColorProp: "fill", drawPoints: function () {
            ...
            n(a.points, function (l) {
                j = l.graphic;
                if (l.plotY !== w) c = l.pointAttr[l.selected ?
        ...
        type: "flags", sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1, forceCrop: !0, init: $.prototype.init, pointAttrToOptions: { fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius" }, translate: function () {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function (a, b) {
                    return a.x - b.x
                }); h-- && b[c];) if (d = b[c], k = g[h], k.x <= d.x && k.plotY !== w) {
                    if (d.x <= m) d.plotY = k.plotY, k.x < d.x && !f && (l = g[h + 1]) && l.plotY !== w && (d.plotY += (d.x - k.x) / (l.x - k.x) * (l.plotY - k.plotY));
                    c--;
                    h++;
                    if (c < 0) break
                }
            ...
            n(b, function (c, d) {
                if (c.plotY === w) c.x >= j.min && c.x <= j.max ? c.plotY = i.lineTop - a.plotTop : c.shapeArgs = {};
    ...
    R = jb("linearGradient", { x1: 0, y1: 0, x2: 0, y2: 1 }, "stops", [
        [0, "#FFF"],
        [1, "#CCC"]
    ]);
    D = [].concat(bc);
    ...
    y(M, {
        navigator: {
            ...
            height: ub ? 20 : 14, barBackgroundColor: R, barBorderRadius: 2, barBorderWidth: 1, barBorderColor: "#666", buttonArrowColor: "#666", buttonBackgroundColor: R, buttonBorderColor: "#666", buttonBorderRadius: 2, buttonBorderWidth: 1, minWidth: 6, rifleColor: "#666", trackBackgroundColor: jb("linearGradient", { x1: 0, y1: 0, x2: 0, y2: 1 }, "stops", [
                [0, "#EEE"],
                [1, "#FFF"]
        ...
        drawHandle: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!this.rendered) {
                    ...
                    if (v) this.scrollbarGroup = k = f.g("scrollbar").add(), l = s.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                ...
                E && (this.leftShade[e]({ x: g, y: z, width: d, height: w }), this.rightShade[e]({ x: g + a, y: z, width: h - a, height: w }), this.outline[e]({ d: ["M", i, F, "L", g + d + y, F, g + d + y, F + J - n, "M", g + a - y, F + J - n, "L", g + a - y, F, i + j, F] }), this.drawHandle(d + y, 0), this.drawHandle(a +
                    y, 1));
                if (v) this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({ translateX: i, translateY: r(F + w) }), o[e]({ width: j }), g = n + d, h = c - H, h < x && (D = (x - h) / 2, h = x, g -= D), this.scrollbarPad = D, l[e]({ x: W(g) + H % 2 / 2, width: h }), x = n + d + c / 2 - 0.5, this.scrollbarRifles.attr({ visibility: c > 12 ? "visible" : "hidden" })[e]({ d: ["M", x - 3, n / 4, "L", x - 3, 2 * n / 3, "M", x, n / 4, "L", x, 2 * n / 3, "M", x + 3, n / 4, "L", x + 3, 2 * n / 3] });
                this.scrollbarPad = D;
                this.rendered = !0
            }
        }, addEvents: function () {
            ...
            a.mouseDownHandler = function (d) {
                ...
                if (u > h && u < h + g + i) if ((h = !a.scrollbarEnabled || u < h + g) && P.abs(s - e - n) < t) a.grabbedLeft = !0, a.otherHandlePos = f; else if (h && P.abs(s - f - n) < t) a.grabbedRight = !0, a.otherHandlePos = e; else if (s > n + e - q && s < n + f + q) {
                    a.grabbedCenter =
                        s;
                    a.fixedWidth = r;
            ...
            a.mouseMoveHandler = function (c) {
                ...
                if (c.pageX !==
                    0) c = b.pointer.normalize(c), l = c.chartX, l < e ? l = e : l > g + h - d && (l = g + h - d), a.grabbedLeft ? (k = !0, a.render(0, 0, l - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, a.render(0, 0, a.otherHandlePos, l - e)) : a.grabbedCenter && (k = !0, l < j ? l = j : l > f + j - i && (l = f + j - i), a.render(0, 0, l - j, l - j + i)), k && a.scrollbarOptions.liveRedraw && setTimeout(function () {
                    a.mouseUpHandler(c)
                }, 0)
            };
            a.mouseUpHandler = function (d) {
                ...
                if (d.type !== "mousemove") a.grabbedLeft =
            ...
            if (a.navigatorEnabled) {
                ...
                r.data = n || x;
                i = b.initSeries(r);
                if (o && f.adaptToUpdatedData !== !1) F(o, "updatedData", a.updatedDataHandler), o.userOptions.events = y(o.userOptions.event, { updatedData: a.updatedDataHandler })
    ...
    sa(Da.prototype, "zoom", function (a, b, c) {
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled)) if (f === "x") d.resetZoomButton = "blocked"; else if (f === "y") h = !1; else if (f === "xy") d = this.previousZoom, v(b) ? this.previousZoom =
        ...
        clickButton: function (a, b, c) {
            ...
            if (!(l === null || o === null || a === d.selected)) {
                if (m[j]) r = m[j] * k, q = t(h - r, l); else if (j ===
                    "month" || j === "year") r = { month: "Month", year: "FullYear" }[j], i["set" + r](i["get" + r]() - k), q = t(i.getTime(), p(l, Number.MIN_VALUE)), r = { month: 30, year: 365 }[j] * 864E5 * k; else if (j === "ytd") if (g) {
                    if (o === w) l = Number.MAX_VALUE, o = Number.MIN_VALUE, n(e.series, function (a) {
                        a = a.xData;
                        l = A(a[0], l);
                        o = t(a[a.length - 1], o)
                    }), c = !1;
            ...
            }).css(z({ textAlign: "center" }, d, f.inputStyle)).on("click",function () {
                    b[a + "Input"].focus()
                }).add(m);
            ...
            i.onchange = function () {
                ...
                if (!isNaN(d) && (M.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >= b.minInput.HCTime)) c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, w,
            ...
            if (d && d.options.ordinal && !d.hasOrdinalExtension) {
                ...
                d.lin2val = function (a, b) {
                    ...
                    if (c) {
                        ...
                        if (b) a < 0 ? a = c[0] : a > k ? a = c[k] : (k = W(a), l = a - k); else for (; k--;) if (m = d * k + e, a >= m) {
                            d = d * (k + 1) + e;
                            l = (a - m) / (d - m);
                            break
                        }
                ...
                d.getNonLinearTimeTicks = function (a, b, c, e, j, k, m) {
                    ...
                    if (!j || j.length === 1 || b === w) return fb(a, b, c, e);
                    for (s =
                             j.length; n < s; n++) {
                        t = n && j[n - 1] > c;
                        j[n] < b && (l = n);
                        if (n === s - 1 || j[n + 1] - j[n] > k * 5 || t) {
                            if (j[n] > z) {
                                for (p = fb(a, j[l], j[n], e); p.length && p[0] <= z;) p.shift();
                    ...
                    if (m && a.unitRange <= I[za]) {
                        n = y.length - 1;
                        for (l = 1; l < n; l++) (new Date(y[l]))[Oa]() !== (new Date(y[l - 1]))[Oa]() && (r[y[l]] = ga, u = !0);
                        u && (r[y[0]] = ga);
                        a.higherRanks = r
                    }
                    y.info = a;
                    if (m && v(A)) {
                        ...
                        for (u = []; m--;) l = d.translate(y[m]), B && (u[m] = B - l), n[m] = B = l;
                        u.sort();
                        u = u[W(u.length / 2)];
                        u < A * 0.6 &&
                        (u = null);
                        m = y[a - 1] > c ? a - 1 : a;
                        for (B = void 0; m--;) l = n[m], c = B - l, B && c < A * 0.8 && (u === null || c < u * 0.8) ? (r[y[m]] && !r[y[m + 1]] ? (c = m + 1, B = l) : c = m, y.splice(c, 1)) : B = l
                    }
                    return y
                };
                var e = b.pan;
    ...
    y(Highcharts, {
        Axis: Da, Chart: Sa, Color: wa, Legend: Hb, Pointer: pb, Point: Ha, Tick: ab, Tooltip: Gb, Renderer: cb, Series: $, SVGElement: Ca, SVGRenderer: Ga, arrayMin: Pa, arrayMax: ua, charts: Ua, dateFormat: ya, format: La, pathAnim: Lb, getOptions: function () {
            return M
