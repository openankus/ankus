...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CF_SIM', {
...
//                    iconCls: 'common-confirm',
                        ...
                        store.on('load', function (store, records) {
                            for (var i = 0; i < records.length; i++) {
                                ...
                                for (var k = 0; k < columnIndexList.length; k++) {
                                    ...
                                    if (columnIndexList[k] == 0) {
                                        changeData = "USER";
                                    } else if (columnIndexList[k] == 1) {
                                        changeData = "ITEM";
                                    } else {
                                        changeData = "";
                                    }
                                    ...
                                    previewGrid.store.sort('rIndex', 'DESC');
                                }
                            }
                        });
                ...
                },
                {
                    ...
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        if (targetCount == r.length) {
                            Ext.getCmp('basedType').setValue('-1');
                        } else if (targetCount === 0) {
                            Ext.getCmp('basedType').setValue('');
                        } else {
                            Ext.getCmp('basedType').setValue(targetIndexList);
                        }
                    }
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'textfield',
                            fieldLabel: MSG.DESIGNER_CF_BASED_SIM_CAL_STANDARD,
                            name: 'basedType',
                            id: 'basedType',
                            readOnly: true,
                            allowBlank: false
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'fieldcontainer',
                            fieldLabel: MSG.DESIGNER_CF_BASED_SIM_ALGORITHM,
                            layout: 'hbox',
                            items: [
                                {
                                    xtype: 'combo',
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: MSG.DESIGNER_CF_BASED_SIM_MINIMUM_EVAL_NUMBER,
                            name: 'commonCount',
                            vtype: 'numeric',
                            value: 20,
                            tooltip: MSG.DESIGNER_MSG_CF_BASED_SIM_MINIMUM_EVAL_NUMBER,
                            allowBlank: false
                        },
                        {
                            xtype: 'textfield',
                            name: 'threshold',
                            vtype: 'decimalpoint',
                            tooltip: MSG.DESIGNER_MSG_CF_BASED_SIM_PRINT_THRESHOLD,
                            fieldLabel: MSG.DESIGNER_CF_BASED_SIM_PRINT_THRESHOLD,
                            value: 0.8,
                            allowBlank: false
                        },
