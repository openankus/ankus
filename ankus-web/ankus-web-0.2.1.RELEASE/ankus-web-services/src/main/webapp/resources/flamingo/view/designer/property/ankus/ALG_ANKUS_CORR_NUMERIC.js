...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CORR_NUMERIC', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_CORR_NUMERIC',
                            ...
                            items: [
                                {
                                    ...
                                    store: Ext.create('Ext.data.Store', {
                                        ...
                                        data: [
                                            ...
                                            {name: 'MAHATTAN DISTANCE', value: 'mahattan', description: 'MAHATTAN DISTANCE'},
