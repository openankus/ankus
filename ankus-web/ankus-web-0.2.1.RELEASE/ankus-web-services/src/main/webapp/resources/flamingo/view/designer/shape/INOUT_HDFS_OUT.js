 ...
 */
Flamingo.view.designer.shape.INOUT_HDFS_OUT = function (image, label) {
    Flamingo.INOUT_HDFS_OUT.superclass.call(this, image, label);
    this.SHAPE_ID = 'Flamingo.view.designer.shape.INOUT_HDFS_OUT';
};
Flamingo.view.designer.shape.INOUT_HDFS_OUT.prototype = new OG.shape.ImageShape();
Flamingo.view.designer.shape.INOUT_HDFS_OUT.superclass = OG.shape.ImageShape;
Flamingo.view.designer.shape.INOUT_HDFS_OUT.prototype.constructor = Flamingo.view.designer.shape.INOUT_HDFS_OUT;
Flamingo.INOUT_HDFS_OUT = Flamingo.view.designer.shape.INOUT_HDFS_OUT;
 ...
 * @override
 */
Flamingo.view.designer.shape.INOUT_HDFS_OUT.prototype.createTerminal = function () {
    if (!this.geom) {
        return [];
    }
