...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CANOPY', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_CANOPY',
...
//                    iconCls: 'common-confirm',
			                ...
			                items: [ 
								...
								},                       
								{
								...
								},  
								 {
		                            ...
		                            name: 't1',
		                            id: 't1',
		                            fieldLabel: 'Canopy Threshold (T1)',
		                            vtype: 'numeric',		                         
		                            allowBlank: true
		                        },
		                        {
		                            ...
		                            name: 't2',
		                            id: 't2',
		                            fieldLabel: 'Remove Threshold (T2)',
		                            vtype: 'numeric',		                            
		                            allowBlank: true
		                        },
		                        {
    ...
    afterPropertySet: function (props) {
        ...
        if (props.t1) {
            props.mapreduce.params.push("-t1", props.t1);
        }
        
        if (props.t2) {
            props.mapreduce.params.push("-t2", props.t2);
        }
