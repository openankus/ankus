...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_ENTROPY_DISCRETIZATION', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_ENTROPY_DISCRETIZATION',
                    ...
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            if (r[i] != null) {
                                ...
                                // Set class attribute(index) list
		                    ...
		                    items: [                                                                
		                        {
		                            ...
		                            name: 'indexList',
		                            id: 'indexList',
		                            fieldLabel: MSG.DESIGNER_NOM_STAT_LIST,
		                            tooltip: MSG.DESIGNER_NOM_STAT_LIST,
