 ...
 */
Ext.define('Flamingo.view.designer.property._TajoDelimiterSelCmbField', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget._tajoDelimiterSelCmbField',

    fieldLabel: MSG.TAJO_DELIMITER,
    defaults: {
        hideLabel: true
    },
    layout: 'hbox',
