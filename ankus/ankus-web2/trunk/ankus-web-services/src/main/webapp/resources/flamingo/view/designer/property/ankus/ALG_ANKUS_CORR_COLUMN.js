...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CORR_COLUMN', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_CORR_COLUMN',
...
//                    iconCls: 'common-confirm',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'fieldcontainer',
                            fieldLabel: 'Similarity/Correlation Algotithm',
                            layout: 'hbox',
                            items: [
                                {
                                    xtype: 'combo',
                                    ...
                                    store: Ext.create('Ext.data.Store', {
                                        ...
                                        data: [
                                            ...
                                            {name: 'TANIMOTO COEFFICIENT', value: 'tanimoto', description: 'TANIMOTO COEFFICIENT'},
                                            {name: 'MANHATAN DISTANCE', value: 'manhatan', description: 'MANHATAN DISTANCE'},
                                            {name: 'UCLIDEAN DISTANCE', value: 'uclidean', description: 'UCLIDEAN DISTANCE'},
                                            ...
                                            {name: 'MATCHING COEFFICIENT', value: 'matching', description: 'MATCHING COEFFICIENT'},
                                            {name: 'EDIT DISTANCE', value: 'edit', description: 'EDIT DISTANCE'}
                                        ]
                                    })
                                }
                            ]
