 ...
 *
 * @class
 * @extends Flamingo.view.designer.property.HADOOP_SHELL
 * @author <a href="mailto:fharenheit@gmail.com">Byoung Gon, Kim</a>
 */
Ext.define('Flamingo.view.designer.property.HADOOP_SHELL', {
    ...
    items: [
        {
            title: MSG.DESIGNER_TITLE_SHELL_SCRIPT,
            xtype: 'form',
            border: false,
            autoScroll: true,
            defaults: {
            ...
            items: [
                {
                    xtype: 'textfield',
                    fieldLabel: MSG.DESIGNER_INTERPRETER_PATH,
                    name: 'path',
                    value: '/bin/bash',
                    ...
                    listeners: {
                        render: function (p) {
                            ...
                            var theTip = Ext.create('Ext.tip.Tip', {
                                html: MSG.DESIGNER_MSG_INTERPRETER,
                                margin: '25 0 0 150',
                                shadow: false
                            });
