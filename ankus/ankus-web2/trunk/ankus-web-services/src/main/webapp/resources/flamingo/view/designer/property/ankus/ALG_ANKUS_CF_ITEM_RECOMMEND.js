...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CF_ITEM_RECOMMEND', {
    ...
    items: [
        {
            ...
            items: [
                         ...
                         
                {
                    ...
                    fieldLabel: MSG.DESIGNER_ITEM_STANDARD,
                    layout: 'hbox',
                    items: [
                        {
                            xtype: 'combo',
                            ...
                            value: 'item',
                            flex: 1,
                            tooltip: MSG.DESIGNER_MSG_ITEM_STANDARD,
                            forceSelection: true,
                            multiSelect: false,
                            disabled: false,
                            editable: false,
                            ...
                            store: Ext.create('Ext.data.Store', {
                                ...
                                data: [
                                    {name: 'ITEM', value: 'item', description: MSG.DESIGNER_ITEM_USER_BASED}
                                ]
                            })
                        }
                    ]
