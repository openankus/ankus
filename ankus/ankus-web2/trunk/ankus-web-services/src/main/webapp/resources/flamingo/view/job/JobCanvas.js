...
Ext.define('Flamingo.view.job.JobCanvas', {
    ...
    requires: [
        ...
        //2015.03.tkkim
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_CORR_COLUMN',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_CF_USER_ITEM_RECOMMEND',        
        //2015.08.13.tkkim
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_ETL',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_DISCRETIZATION',
        
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_C45',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_ENTROPY_DISCRETIZATION',
        
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_FPGWOWTH',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_kNN',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_NAIVE_BAYES',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_CANOPY',
        ...
        //2015.03.tkkim
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_CORR_COLUMN',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_CF_USER_ITEM_RECOMMEND',
        //2015.08.13.tkkim
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_ETL',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_DISCRETIZATION',
        
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_C45',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_ENTROPY_DISCRETIZATION',
        
        
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_FPGWOWTH',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_kNN',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_NAIVE_BAYES',
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_CANOPY',
        ...
        'Flamingo.view.designer.property.ankus.ALG_ANKUS_COMMON_INPUT',
        'Flamingo.view.designer.shape.ankus.ALG_ANKUS_COMMON_INPUT'
    ],
