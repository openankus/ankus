...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_C45', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_C45',
...
//                    iconCls: 'common-confirm',
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        previewGrid.reconfigure(store, [
                            ...
                            },
                            {
                                ...
                                width: 75,
                                header: 'Numeric',
                                dataIndex: 'filterTargetCheckIndex',
                                listeners: {
                                    checkchange: function (column, recordIndex, checked) {
                                        var record = previewGrid.getStore().getAt(recordIndex);
                                        var dataIndex = this.dataIndex;
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    checkchange: function (column, recordIndex, checked) {
                                        ...
                                        var str_filter = record.get('filterTargetCheckIndex');
                                        
                                        if(str_filter==true){
                                       	 record.set('filterTargetCheckIndex', checked);	
                                        }
                            ...
                            handler: function (store) {
                                ...
                                for (var i = 0; i < range.length; i++) {
                                    if (range[i] != null) {
                                        ...
                                        record.set('filterTargetCheckIndex', false);
                        ...
                        },
                        {
                            ...
                            handler: function (store) {
                                ...
                                for (var i = 0; i < range.length; i++) {
                                    if (range[i] != null) {
                                        var record = previewGrid.getStore().getAt(i);
                                        record.set('filterTargetCheckIndex', true);                                        
                    ...
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            if (r[i] != null) {
                                ...
                                if (r[i].data.filterTargetCheckIndex) filterTargetCount++;
                        ...
                        for (var i = 0; i < r.length; i++) {
                            if (r[i] != null) {
                                ...
                                if (filterTargetCount != r.length && filterTargetCount != 0) {
                                    if (r[i].data.filterTargetCheckIndex) {
                                    	filterIndexList.push(r[i].data.rIndex);
                                        if (filterTargetCount === filterTargetCount - 1) {
                        ...
                        if (filterTargetCount == r.length) {
                            Ext.getCmp('filterIndexList').setValue('-1');
                        } else if (filterTargetCount === 0) {
                            Ext.getCmp('filterIndexList').setValue('');
                        } else {
                            Ext.getCmp('filterIndexList').setValue(filterIndexList);
                        }
                ...
                },
                {
                    ...
                    items: [
                                ...
                                for (var i = 0; i < range.length; i++) {
                                    if (range[i] != null) {
                            			...
                            			*/
                            			...
                            			Ext.getCmp('filterIndexList').disable();	//Exception Att.
                            			Ext.getCmp('minLeafData').disable();		//Pruning Min.
                            			Ext.getCmp('purity').disable();				//Pruning Left.    
                            			Ext.getCmp('myRadio').disable();			//Training Result.    
                            			Ext.getCmp('classIndex').allowBlank=true;
                            		}else{
                            		
                            			Ext.getCmp('modelPath').disable();	
                            			Ext.getCmp('indexList').enable();	
                            			Ext.getCmp('filterIndexList').enable();	
                            			Ext.getCmp('minLeafData').enable();	
                            			Ext.getCmp('purity').enable();	
                        ...
                        },
                        {
                            ...
                            id: 'filterIndexList',
                            fieldLabel: MSG.DESIGNER_C45_FILTER_INCLUDE_LIST,
                            vtype: 'commaseperatednum',
                            allowBlank: true
                        },
                        {
    ...
    afterPropertySet: function (props) {
        ...
        if (props.filterIndexList) {
            props.mapreduce.params.push("-filtertargetList", props.filterIndexList);
        }
