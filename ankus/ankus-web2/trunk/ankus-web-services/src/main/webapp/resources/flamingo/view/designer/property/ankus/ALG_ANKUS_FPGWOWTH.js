...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_FPGWOWTH', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_FPGWOWTH',
...
//                    iconCls: 'common-confirm',
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        var store = Ext.create('Ext.data.Store', {
                            ...
                            proxy: {
                                type: 'ajax',
                                url: CONSTANTS.CONTEXT_PATH + CONSTANTS.DESIGNER.LOAD_HDFS_FILE_FP,
                                headers: {
                    ...
                    items: [
                        ...
                        */
                        ...
                        },
                        {
                            ...
                            name: 'maxRuleLength',
                            id: 'maxRuleLength',
                            fieldLabel: 'Maximum Rule Length',
                            vtype: 'numeric',
                            allowBlank: true
                        },
                        {
                            ...
                            items: [
                                {
                                    ...
                                    store: Ext.create('Ext.data.Store', {
                                        fields: ['name', 'value', 'description'],
                                        data: [
                                            {name: 'CONFIDENCE', value: 'confidence', description: 'CONFIDENCE'},
                                            {name: 'LIFT', value: 'lift', description: 'LIFT'}
                                        ]
                                    })                                    
                                }
                            ]
    ...
    afterPropertySet: function (props) {
        ...
        if (props.minSup) {
            props.mapreduce.params.push("-minSup", props.minSup);
        }

        if (props.maxRuleLength) {
            props.mapreduce.params.push("-maxRuleLength", props.maxRuleLength);
        }

        if (props.metricType) {
            props.mapreduce.params.push("-metricType", props.metricType);
        }

        if (props.metricValue) {
            props.mapreduce.params.push("-metricValue", props.metricValue);
        }

        if (props.ruleCount) {
            props.mapreduce.params.push("-ruleCount", props.ruleCount);
        }

        if (props.targetItemList) {
            props.mapreduce.params.push("-targetItemList", props.targetItemList);
        }
