...
Ext.define('Flamingo.view.hive.browser.Column', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.hiveColumn',
                ...
                tbar: [
                    {
                        ...
                        iconCls: 'column-add',
                        handler: function () {
                            var gridStore = Ext.ComponentQuery.query('#columnGrid')[0].getStore();
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            var grid = Ext.ComponentQuery.query('#columnGrid')[0];
