 ...
 */
Ext.define('Flamingo.controller.visualization.WorkflowHistoryController', {
    extend: 'Ext.app.Controller',
    alias: 'controller.vizworkflowHistoryController',
    ...
    init: function () {
        this.control({
            'visualizationWorkflowHistory #first': {
                click: this.onPagingClick
            },
            'visualizationWorkflowHistory #prev': {
                click: this.onPagingClick
            },
            'visualizationWorkflowHistory #next': {
                click: this.onPagingClick
            },
            'visualizationWorkflowHistory #last': {
                click: this.onPagingClick
            },
            'visualizationWorkflowHistory #findWorkflowButton': {
                click: this.onFindClick
            },
            'visualizationWorkflowHistory #clearWorkflowButton': {
                click: this.onClearClick
            },
            'visualizationWorkflowHistory > grid': {
    ...
    onPagingClick: function () {
        var panel = query('visualizationWorkflowHistory');
        ...
        var workflowHistoryPanel = query('visualizationWorkflowHistory gridpanel');
