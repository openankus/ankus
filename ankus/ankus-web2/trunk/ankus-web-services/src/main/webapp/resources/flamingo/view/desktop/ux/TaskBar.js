...
/**
 * @class Flamingo.view.desktop.ux.TaskBar
 * @extends Ext.toolbar.Toolbar
 */
Ext.define('Flamingo.view.desktop.ux.TaskBar', {
    ...
    requires: [
        ...
        'Flamingo.view.desktop.ux.StartMenu'
    ],
     ...
     */
    startBtnText: MSG.MENU_START,

    initComponent: function () {
        var me = this;

        me.startMenu = new Flamingo.view.desktop.ux.StartMenu(me.startConfig);
        ...
        me.items = [
            {
                xtype: 'button',
                cls: 'ux-start-button',
                //iconCls: 'ux-start-button-icon', TODO - Start아이콘 추가시 css에 클래스 추가하고 사용
                menu: me.startMenu,
                menuAlign: 'bl-tl',
...
/**
 * @class Flamingo.view.desktop.ux.TrayClock
 * @extends Ext.toolbar.TextItem
 * This class displays a clock on the toolbar.
 */
Ext.define('Flamingo.view.desktop.ux.TrayClock', {
