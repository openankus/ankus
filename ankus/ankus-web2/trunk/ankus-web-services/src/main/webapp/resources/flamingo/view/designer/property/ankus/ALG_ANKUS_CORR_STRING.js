...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_CORR_STRING', {
                ...
                },
                {
                    ...
                    handler: function (store) {
                        ...
                        if (exceptionCount == r.length) {
                            Ext.getCmp('computeIndex').setValue('-1');
                        } else if (exceptionCount === 0) {
                            Ext.getCmp('computeIndex').setValue('');
                        } else {
                            Ext.getCmp('computeIndex').setValue(exceptionIndexList);
                        }
                    }
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: MSG.DESIGNER_CORR_TARGET,
                            name: 'computeIndex',
                            id: 'computeIndex',
                            allowBlank: false
                        },
