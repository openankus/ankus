 ...
 */
Flamingo.view.designer.shape.INOUT_HDFS_IN = function (image, label) {
    Flamingo.INOUT_HDFS_IN.superclass.call(this, image, label);
    this.SHAPE_ID = 'Flamingo.view.designer.shape.INOUT_HDFS_IN';
};
Flamingo.view.designer.shape.INOUT_HDFS_IN.prototype = new OG.shape.ImageShape();
Flamingo.view.designer.shape.INOUT_HDFS_IN.superclass = OG.shape.ImageShape;
Flamingo.view.designer.shape.INOUT_HDFS_IN.prototype.constructor = Flamingo.view.designer.shape.INOUT_HDFS_IN;
Flamingo.INOUT_HDFS_IN = Flamingo.view.designer.shape.INOUT_HDFS_IN;
 ...
 * @override
 */
Flamingo.view.designer.shape.INOUT_HDFS_IN.prototype.createTerminal = function () {
    if (!this.geom) {
        return [];
    }
