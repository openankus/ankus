...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_EM', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_EM',
                    ...
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            if (r[i] != null) {
                                ...
                                if (r[i].data.nominalCheckIndex) classCount++;
                            }
                        }
                        ...
                        if (classCount == r.length) {
                            ...
                            Ext.getCmp('nominalIndexList').setValue(classIndexList);
                        }
                    }
                },
                {
                    ...
                    items: [
                            ...
                            listeners: {
                            	change: function(field, value){                            		
                            		if(value.suppliedTest == 'true'){
                            			...
                            			Ext.getCmp('finalResultGen').disable();			//Training Result.                           			
                            		}else{
                            			...
                            			Ext.getCmp('finalResultGen').enable();	                            			
                            		}
                            	}
                            }                            
                        },                       
                        ...
                        },
                        {
                            ...
                            name: 'indexList',
                            id: 'indexList',
                            fieldLabel: MSG.DESIGNER_EM_INCLUDE_LIST,
                            tooltip: MSG.DESIGNER_MSG_EM_INCLUDE_LIST,
                        ...
                        },
                        {
                            ...
                            fieldLabel: MSG.DESIGNER_EM_EXCLUDE_LIST,
                            vtype: 'commaseperatednum',
                            allowBlank: true
                        },
                        {
                            ...
                            name: 'clusterCnt',
                            id: 'clusterCnt',
                            fieldLabel: MSG.DESIGNER_EM_CLUSTER_NUMBER,
                            value: 2,
                            allowBlank: false
                        },
                        {
                        ...
                        },
                        {
                            ...
                            name: 'maxIteration',
                            id: 'maxIteration',
                            fieldLabel: MSG.DESIGNER_EM_MAX_ITERATION,
                            value: 100,
                            vtype: 'numeric',
                            allowBlank: false
                        },
