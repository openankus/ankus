...
Ext.define('Flamingo.view.visualization.WorkflowHistory', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.visualizationWorkflowHistory',

    requires: [
        'Flamingo.view.component._WorkflowEngineCombo'
    ],

    controllers: ['Flamingo.controller.visualization.WorkflowHistoryController'],
            ...
            items: [
                {
                    ...
                    columns: [
                        ...
                        {text: 'Chart Title', flex: 1, dataIndex: 'workflowName', align: 'center', sortable: false},
                        ...
                        },
                        {
                            ...
                            listeners: {
                                change: function (field, newValue, oldValue) {
                                    Ext.ComponentQuery.query('visualizationWorkflowHistory #engineId')[0].setValue(newValue);

                                    // Fire a click event of find button.
                                    var findButton = Ext.ComponentQuery.query('visualizationWorkflowHistory #findWorkflowButton')[0];
                    ...
                    listeners: {
                        afterrender: function () {
                            ...
                            var workflowHistoryPanel = Ext.ComponentQuery.query('visualizationWorkflowHistory')[0].down('gridpanel');                        	
