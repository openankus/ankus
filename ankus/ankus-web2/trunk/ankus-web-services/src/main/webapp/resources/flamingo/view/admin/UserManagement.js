            ...
            items: [
                {
                    ...
                    columns: [
                        {text: MSG.COMMON_USERNAME, flex: 1, dataIndex: 'username', align: 'center'},
                        
                        {text: MSG.COMMON_EMAIL, flex: 1, dataIndex: 'email', align: 'center'},
                        {
                            header: 'Enabled',
                            dataIndex: 'enabled',
                            flex: 1,
                        ...
                        {text: MSG.COMMON_LAST_LOGIN_TIME, flex: 1, dataIndex: 'lastlogin', align: 'center',
                        ...
                        {text: MSG.COMMON_CREATE_DATE, flex: 1, dataIndex: 'createDate', align: 'center',
                            renderer: function (value) {
                                return Flamingo.Util.Date.format(new Date(value), 'yyyy-MM-dd HH:mm:ss');
                            }
                        }
