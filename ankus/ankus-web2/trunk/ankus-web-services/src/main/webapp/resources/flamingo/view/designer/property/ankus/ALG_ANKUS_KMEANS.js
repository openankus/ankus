...
Ext.define('Flamingo.view.designer.property.ankus.ALG_ANKUS_KMEANS', {
    extend: 'Flamingo.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_ANKUS_KMEANS',
...
//                    iconCls: 'common-confirm',
                    handler: function (grid, rowIndex, colIndex) {
                        ...
                        //TODO STORE 에러 생길 경우, 에러 메시지..화면에 뿌려주기..
                    ...
                    handler: function (store) {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            if (r[i] != null) {
                                ...
                                // Set nominal target attribute(index)
                ...
                },
                {
                    ...
                    items: [
                            ...
                            listeners: {
                            	change: function(field, value){                            		
                            		if(value.suppliedTest == 'true'){
                            			...
                            			Ext.getCmp('indexList').disable();			//Target Att.                            			
                            			Ext.getCmp('nominalIndexList').disable();	//Nominal Target
                            			Ext.getCmp('exceptionIndexList').disable();	//Exception Att.
                            			Ext.getCmp('myRadio').disable();			//Numeric Att.   
                            			Ext.getCmp('clusterCnt').disable();			//Number. 
                            			Ext.getCmp('convergeRate').disable();		//Conver. 
                            			Ext.getCmp('maxIteration').disable();		//Max Iter. 
                            			Ext.getCmp('resultGenRadio').disable();		//Training Result. 
                            			...
                            			Ext.getCmp('myRadio').enable();	
                            			Ext.getCmp('clusterCnt').enable();	
                            			Ext.getCmp('convergeRate').enable();		
                            			Ext.getCmp('maxIteration').enable();
                            			Ext.getCmp('resultGenRadio').enable();	                            				                            			
                            		}
                            	}
                            }                            
                        },                       
                        ...
                        },
                        {
                            ...
                            name: 'indexList',
                            id: 'indexList',
                            fieldLabel: MSG.DESIGNER_K_MEANS_INCLUDE_LIST,
                            tooltip: MSG.DESIGNER_MSG_K_MEANS_INCLUDE_LIST,
...

                        {
                            ...
                            id: 'nominalIndexList',
                            fieldLabel: MSG.DESIGNER_K_MEANS_TARGER_INCLUDE_LIST,
                            allowBlank: true
                        },
                        {
                            xtype: 'textfield',
                            ...
                            fieldLabel: MSG.DESIGNER_K_MEANS_EXCLUDE_LIST,
                            vtype: 'commaseperatednum',
                            allowBlank: true
                        },
                        /*
                        {
                            xtype: 'radiogroup',
                            fieldLabel: MSG.DESIGNER_K_MEANS_NORMALIZATION,
                            allowBlank: false,
                            columns: 2,
                            itemId: 'myRadio',
                            id: 'myRadio',
                        ...
                        */
                        {
                            ...
                            name: 'clusterCnt',
                            id: 'clusterCnt',
                            fieldLabel: MSG.DESIGNER_K_MEANS_CLUSTER_NUMBER,
                            value: 2,
                            allowBlank: false
                        },
                        {
                        ...
                        },
                        {
                            ...
                            name: 'maxIteration',
                            id: 'maxIteration',
                            fieldLabel: MSG.DESIGNER_K_MEANS_MAX_ITERATION,
                            vtype: 'numeric',
                            value: 100,
                            allowBlank: false
                        },
                        {
                            xtype: 'radiogroup',
                            fieldLabel: 'Training Result Generation',
                            allowBlank: false,
                            columns: 2,
                            itemId: 'resultGenRadio',
                            id: 'resultGenRadio',
                            items: [
                                {
                                    xtype: 'radiofield',
...
//		},
    ...
    afterPropertySet: function (props) {
        ...
        /*
        if (props.normalize) {
            props.mapreduce.params.push("-normalize", props.normalize);
        }
		*/
        ...
        if (props.clusterCnt) {
            props.mapreduce.params.push("-clusterCnt", props.clusterCnt);
        }
        ...
        if (props.convergeRate) {
            props.mapreduce.params.push("-convergeRate", props.convergeRate);
        }
