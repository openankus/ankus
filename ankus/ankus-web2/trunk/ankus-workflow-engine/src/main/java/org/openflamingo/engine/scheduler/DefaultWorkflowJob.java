...
public class DefaultWorkflowJob extends DefaultQuartzJob {
    ...
    public void executeInternal(WorkflowContext workflowContext) {
        ...
        workflowContext.setValue(JobVariableWorkFlow.TOTAL_STEPS, String.valueOf(actions.size()));
        workflowContext.setValue(JobVariableWorkFlow.CURRENT_STEP, "1");
        ...
        for (String action : actions) {
            ...
            workflowContext.setValue(JobVariableWorkFlow.ACTION_CURRENT, action);
            workflowContext.setValue(JobVariableWorkFlow.ACTION_CURRENT_DESC, ((BaseType) type).getDescription());
            workflowContext.setValue(JobVariableWorkFlow.CURRENT_STEP, String.valueOf(currentPos));
            ...
            String actionName = workflowContext.getValue(JobVariableWorkFlow.ACTION_CURRENT_DESC);
            ...
            try {
                ...
                workflowContext.setObject(JobVariableWorkFlow.WORKFLOW_EXCEPTION, ex);
