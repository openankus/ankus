...
public interface WorkflowHistoryRepository extends PersistentRepository<WorkflowHistory, Long> {
    ...
    List<WorkflowHistory> selectByConditionViz(String startDate, String endDate, String workflowName, String jobType, String username, String status, String orderBy, String desc, int start, int limit);

	List<WorkflowHistory> selectByJobStringId(String jobStringId);
