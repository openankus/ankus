...
public class PrepareActionStateHandler implements ActionStateHandler {
    ...
    public ActionHistory changeStatus(ActionContext actionContext) {
        ...
        actionHistory.setTotalStep(Integer.parseInt(actionContext.getWorkflowContext().getValue(JobVariableWorkFlow.TOTAL_STEPS)));
        actionHistory.setCurrentStep(Integer.parseInt(actionContext.getWorkflowContext().getValue(JobVariableWorkFlow.CURRENT_STEP)));
        ...
        actionContext.setObject(JobVariableWorkFlow.ACTION_HISTORY, inserted);
    ...
    private void updateWorkflowStep(ActionContext actionContext) {
        int totalStep = Integer.parseInt(actionContext.getWorkflowContext().getValue(JobVariableWorkFlow.TOTAL_STEPS));
        int currentStep = Integer.parseInt(actionContext.getWorkflowContext().getValue(JobVariableWorkFlow.CURRENT_STEP));
