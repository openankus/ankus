...
/**
 * Action의 상태를 처리하는 핸들러. Action의 상태가 여러 종류인 경우 각각의 상태에 따라서 핸들러를 구현해야 한다.
 *
 * @author Byoung Gon, Kim
 * @since 0.2
 */
public interface ActionStateHandler {
     ...
     */
    ActionHistory changeStatus(ActionContext actionContext);
