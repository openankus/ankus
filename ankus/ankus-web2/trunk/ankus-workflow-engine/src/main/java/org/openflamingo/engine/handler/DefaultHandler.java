...
public abstract class DefaultHandler<T> implements Handler<T> {
    ...
    public void execute(WorkflowContext context) {
        ...
        try {
            ...
            actionContext.setObject(JobVariableWorkFlow.ACTION_EXCEPTION, ex);
            fail();
    ...
    public ActionHistory getActionHistory() {
        return (ActionHistory) actionContext.getObject(JobVariableWorkFlow.ACTION_HISTORY);
    }
    ...
    public WorkflowHistory getWorkflowHistory() {
        return (WorkflowHistory) actionContext.getWorkflowContext().getObject(JobVariableWorkFlow.WORKFLOW_HISTORY);
    }
