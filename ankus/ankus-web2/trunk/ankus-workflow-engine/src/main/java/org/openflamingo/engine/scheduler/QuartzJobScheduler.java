        ...
        try {
            ...
            for (String groupName : scheduler.getJobGroupNames()) {
                for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.jobGroupEquals(groupName))) {
                    ...
                    Workflow workflow = (Workflow) jobDetail.getJobDataMap().get(JobVariableWorkFlow.WORKFLOW);
                    ...
                    if (workflow != null) {
                        ...
                        job.put("name", jobDetail.getJobDataMap().get(JobVariableWorkFlow.JOB_NAME));
                        job.put("jobId", jobDetail.getJobDataMap().get(JobVariableWorkFlow.JOB_KEY));
