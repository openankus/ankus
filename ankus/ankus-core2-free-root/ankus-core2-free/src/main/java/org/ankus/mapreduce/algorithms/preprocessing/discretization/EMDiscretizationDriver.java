 ...
 * @author Moonie
 */
public class EMDiscretizationDriver extends Configured implements Tool {

    private Logger logger = LoggerFactory.getLogger(EMDiscretizationDriver.class);
	...
	public int run(String[] args) throws Exception
	{
        ...
        //int res = ToolRunner.run(new ID3Driver(), params);
        if(res!=0)
        {
	...
	{
		int res = ToolRunner.run(new EMDiscretizationDriver(), args);
        System.exit(res);
	}
